  ...
  const renderContent = () => {
    switch (gameState) {
      case GameState.Quiz:
        ...
        return (
          currentGrade && <QuizScreen grade={currentGrade} onQuizComplete={handleQuizComplete} onGoHome={handleGoHome} />
        );
      case GameState.Results:
        return (
          currentGrade && <ResultsScreen 
            score={finalScore} 
      ...
      case GameState.ColorList:
        return <ColorListScreen onGoHome={handleGoHome} />;
      case GameState.Home:
      default:
        return <HomeScreen onSelectGrade={handleSelectGrade} onShowColorList={handleShowColorList} isUnlocked={isUnlocked} />;
    }
  };
