		...
		<>
			<div className='w-full max-w-2xl mx-auto py-4 sm:p-6 flex flex-col h-full'>
				...
				<main className='flex-grow flex flex-col items-center justify-center'>
					<div className='w-full max-w-md bg-white p-4 rounded-2xl shadow-xl border border-slate-200'>
						<div className='w-full h-44 sm:h-64 rounded-xl mb-6 border-8 border-slate-200 shadow-inner' style={{ backgroundColor: currentQuestion.correctAnswer.color_code }}></div>
